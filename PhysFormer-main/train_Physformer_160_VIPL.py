...
def train_test():
    ...
    # Dataset root
    VIPL_root_list = 'content/PhysFormer-main/vipl_hr_partial/p0'
    VIPL_train_list = 'content/PhysFormer-main/vipl_hr_partial/p0/total.txt'
    #need to change this!!
...
if __name__ == "__main__":
    ...
    parser.add_argument('--input_data', type=str, default="p0") # /scratch/project_2003204/VIPL_frames_Matlab/
